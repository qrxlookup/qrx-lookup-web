            ...
            existingUser ? (
                ...
                <form onSubmit={handleSubmit} className='login-form'>
                    ...
                    <div className='button-box'>
                        <button className='primary-button' type='button' onClick={handleSendResetPasswordEmail}>Reset</button>
                        <button className='primary-button' type='button' onClick={handleLoginWithGoogle}>Google</button>
